...
export class ApiService {
  ...
  public changeStatusTitle(todo: Todo, status: number, title: string) {
    return this.httpClient.put(`${this.API_SERVER}/${todo.id}/changestatustitle`, {todo: todo, status: status, title: title});
  }
